...
- 11 pruebas JavaScript/HTTP: las cinco originales de fechas, cancelación, escape e ICS, más contacto, tokens, validación CAPTCHA, origen, fallos cerrados, límites y contrato del gateway. Adaptadores externos simulados.
